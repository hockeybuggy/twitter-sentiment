...
Accuracy is used as a secondary performance measure. While more intuitive, it
is not used as a primary evaluation measure due to it's tendency to be biased
by uneven numbers of examples particular labels in the dataset. Accuracy,
henceforth referred to as $Acc$, can be calculate with the following formula:
...
\begin{table}[H]
    ...
    \begin{tabular}{|r||c|c|c|c|c|}
        ...
        \hline
        Baseline       & 48.37   & 2.15 & -     & & \\
        Just Stopwords & 48.27   & 1.83 & -0.10 & 62.07 & 1.69 \\
        Just Uncommon  & 49.02   & 1.96 &  0.65 & 62.47 & 1.91 \\
        Just Normalize & 49.55   & 2.10 &  1.18 & 63.57 & 1.75 \\
        All            & \textbf{50.96} & 1.93 &  2.59 & \textbf{63.82} & 0.91 \\
        \hline
    \end{tabular}
    \end{center}
