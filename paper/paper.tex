...
Sentiment analysis is a very specific type of \textbf{text classification}, a problem
that is well summarized in chapter 6 of \textit{Mining Text Data} by Aggarwal
and Zhai \cite{Aggarwal2012} as:
...
normalization. The F-score that is achieved is \textbf{50.72}.

%TODO consider cleaning the text up here
...
%TODO add references to the feature selection section
