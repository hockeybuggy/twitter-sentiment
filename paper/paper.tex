...
\subsection{Smooth Performance Measurement}
...
in Table \ref{table:maxent-results} to see the results in context.
...
\begin{table}[H]
    ...
    \begin{tabular}{|c||r|r|r|r|r|}
        \hline
        Description        & Positive & Neutral & Negative & Overall & Total \\
        \hline
        All                & 14.85    & 14.06   & 15.10    & 14.49   & 5964 \\
        Just Stopwords     & 15.95    & 15.40   & 16.33    & 15.73   & 0 \\
        Just Uncommon      & 18.54    & 17.81   & 18.82    & 18.22   & 5993 \\
        Just Normalization & 19.64    & 19.15   & 20.05    & 19.46   & 0 \\
        Baseline           & 20.65    & 20.45   & 20.96    & 20.58   & 0 \\
        \hline
    \end{tabular}
    \end{center}
...
\begin{table}[H]
    ...
    \begin{tabular}{|r||c|c|}
        \hline
           Description    & mean F & std F \\
        \hline
           All            & 0.0    & 0.0   \\
           Just Stopwords & 0.0    & 0.0   \\
           Just Uncommon  & 0.0    & 0.0   \\
           Just Normalize & 0.0    & 0.0   \\
           Baseline       & 0.0    & 0.0   \\
        \hline
    \end{tabular}
    \end{center}
...
% TODO test this and make a dist branch
    ...
    \item \textbf{Install Prerequisites} - If \textit{python 2.7}, \textit{pip}, and \textit{flex} are not
...
\end{Verbatim}
    ...
    \item \textbf{Run the Program} - The classifier can be executed in a number of ways. There are two python programs that are executable: `conductor.py' and `crossval.py'. These two programs run the classifier in a simple fashion or with cross validation. There are a large number of command line arguments that can be viewed with:
\begin{Verbatim}[fontsize=\footnotesize]
python conductor -h
\end{Verbatim}
