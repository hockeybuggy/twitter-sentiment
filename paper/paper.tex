...
\begin{table}[H]
    ...
    \begin{tabular}{|c||r|r|r|r|}
        ...
        \hline
        \textit{a}, \textit{i} & 14.85    & 14.06   & 15.10    & 14.49 \\
        \textit{b}, \textit{j} & 14.91    & 14.30   & 15.30    & 14.67 \\
        \textit{c}, \textit{k} & 15.95    & 15.40   & 16.33    & 15.73 \\
        \textit{d}, \textit{l} & 17.13    & 16.86   & 17.41    & 17.04 \\
        \textit{e}, \textit{m} & 18.54    & 17.81   & 18.82    & 18.22 \\
        \textit{f}, \textit{n} & 18.43    & 17.87   & 18.85    & 18.21 \\
        \textit{g}, \textit{o} & 19.64    & 19.15   & 20.05    & 19.46 \\
        \textit{h}, \textit{p} & 20.65    & 20.45   & 20.96    & 20.58 \\
        \hline
    \end{tabular}
    \end{center}
    \caption{The average number of features in each experiment}
